<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/banithani.in/admin/');
define('HTTP_CATALOG', 'http://localhost/banithani.in/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/banithani.in/admin/');
...
define('DB_PASSWORD', '');
define('DB_DATABASE', 'bantnproductiondb');
define('DB_PORT', '3306');
define('DB_PREFIX', 'bntn_');
